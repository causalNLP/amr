...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default="/home/yuenchen/amr_computation/ldc_slang_to_amr.csv", help='the input csv file')
    parser.add_argument('--output_file', type=str, default='/home/yuenchen/amr_computation/AMR3-structbart-L_slang_output.csv',  help='the output csv file')
